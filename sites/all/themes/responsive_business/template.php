 ...
 */
function responsive_business_html_head_alter(&$head_elements) {
 ...
 */
function responsive_business_preprocess_page(&$vars) {
 ...
 */
function responsive_business_menu_local_tasks(&$variables) {
  $output = '';
...
function responsive_business_page_alter($page) {
